...
//************************************************
    SearchPage search = new SearchPage();  // new object to use in class to call method
//***************************************************
    ...
    public void  user_search_with_the_name_of_the_product()
    {
        ...
        //Hooks.driver.findElement(By.id("small-searchterms"))
             search.searchCamera().sendKeys("camera");

      //  Hooks.driver.findElement(By.cssSelector("button[class=\"button-1 search-box-button\"]"))
...
//            soft.assertTrue(Hooks.driver.findElement(By.cssSelector("[alt=\"Picture of Leica T Mirrorless Digital Camera\"]")).isDisplayed(),"first assertion photo ");
    ...
    {
        //Hooks.driver.findElement(By.cssSelector("[href=\"/jewelry\"]"))

              search.searchJewellry() .click();
    }
...
@Then("user is able to find what lookig for from categories")
    public void find_category_products()
    {
...

        {
            ...
            soft.assertTrue(search.aassertcheckphoto().isDisplayed(),"first assertion of photos ");
